...
<asp:Content ID="Content2" ContentPlaceHolderID="GameContent" runat="server">
    ...
    <div>
        ...
        <div style="float:left; width:76%; color:#ffffff;" > <!-- Right -->
            <asp:Label runat="server" ID="ItemTypeLbl"></asp:Label>
            <br />
            <asp:Label runat="server" ID="ItemName"></asp:Label>
            <br />
            <asp:Label runat="server" ID="ItemTypeMeaning"></asp:Label>
            <span style="color:#83F52C;">&nbsp;+&nbsp;<asp:Label runat="server" ID="ItemBooster"></asp:Label></span>
            <br />
            <p style="float:left; color:#f1e51e;" class="line-1 anim-typewriter"><asp:Label runat="server" ID="ItemPrice"></asp:Label></p> 
            <p style="float:left; color:#fffaad;">&nbsp;Coins</p> 
            <div style="clear:both;"></div>
            <br />
            <br />
            <p style="color:#dbdbdb;"><asp:Label runat="server" ID="ItemDesc"></asp:Label></p>
            <br />
        </div>
        <div style="clear:both;"></div>
    </div>
